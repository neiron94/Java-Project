...
import static my_utils.Constants.EnemyConstants.KnightConstants.*;
...
public class Knight extends Enemy {
    ...
    /**
     * Configures knight's start state.
    ...
    public void render(Graphics g) {
        g.drawImage(Images.getKnightEnemyAnimations()[getIntByState(state)][animIndex], (int)x + flipX, (int)y, REAL_SPRITE_WIDTH * flipW, REAL_SPRITE_HEIGHT, null);

        // If knight is dead and on the last sprite of death animation
